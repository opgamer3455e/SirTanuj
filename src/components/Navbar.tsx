      ...
      <div className="relative w-full max-w-[800px] pointer-events-auto">
        ...
        >
          ...
          <button
            ...
            className="flex md:hidden items-center justify-center p-2 rounded-full hover:bg-white/5 text-zinc-300 hover:text-white focus:outline-none transition-colors"
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute top-full left-0 right-0 mt-3 bg-black/80 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-2xl z-40 flex flex-col md:hidden"
            >
